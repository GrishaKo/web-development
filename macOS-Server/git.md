# Заметки по использованию Git на macOS
...
[Git](https://git-scm.com/) -  распределённая система управления версиями.
  ...
  * [Использование](#использование)
	 ...
	 * [Создание репозитория в каталоге проекта](#создание-репозитория-в-каталоге-проекта)
...
Отвержение необратимых преобразований для текущей настройки core.autocrlf:
...
Устанавливаем редактор "nano" по умолчанию для создания и редактирования сообщений коммитов и меток:
...
Создаем и редактируем файл для указания игнорируемых файлов и папок, которые не должны добавляться в репозиторий:
