...
## Предпочтительно установить с помощью менеджера пакетов

Для macOS [HomeBrew](https://brew.sh):
...
2. [Отличный интерактивный тур](https://githowto.com/ru)
3. [Видео инструкция по клонированию проекта Laravel из удаленного репозитория](https://www.youtube.com/watch?v=PNka4eZ5ojg)

# Подборка

Предпочтительный вариант по использованию, описан ниже под заголовком "Настройка своего Git-сервера с помощью Gitolite", где также приведены все основные пример использования, достаточные для полноценный работы с Git на своем сервере.
